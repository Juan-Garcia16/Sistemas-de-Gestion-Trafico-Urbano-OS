...
class Settings(BaseModel):
    ...
    # Semáforos
    TRAFFIC_LIGHT_DEFAULT_GREEN: int = 8
    TRAFFIC_LIGHT_DEFAULT_RED: int = 8
    TRAFFIC_LIGHT_YELLOW_DURATION: int = 2

    # Vehículos
    VEHICLE_SPAWN_INTERVAL: int = 1000
    VEHICLE_MAX_FLEET: int = 10
    VEHICLE_MAX_LIFETIME: int = 100
...
VEHICLE_SPAWN_INTERVAL = settings.VEHICLE_SPAWN_INTERVAL
VEHICLE_MAX_FLEET = settings.VEHICLE_MAX_FLEET
VEHICLE_MAX_LIFETIME = settings.VEHICLE_MAX_LIFETIME
MAX_DISPATCH_PER_INTERSECTION_PER_TICK = settings.MAX_DISPATCH_PER_INTERSECTION_PER_TICK
